...
public final class Essential extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        I18N.setDefaultByLang("de_DE", "citybuild.tpa.self.accept", "§7%player% hat deine Anfrage angenommen und wird in 3 Sekunden zu dir teleportiert.");
        ...
        I18N.setDefaultByLang("de_DE", "citybuild.tpahere.self.accept", "§7%player% hat deine Anfrage angenommen und du wirst in 3 Sekunden teleportiert.");
        ...
        I18N.setDefaultByLang("en_GB", "citybuild.tpa.self.accept", "§7%player% has accepted your request and will teleport to you in 3 seconds.");
