...
public class PMenuSetHomeMenu extends Menu {

    private final Player player;
    private final PlotPlayer<?> plotPlayer;

    public PMenuSetHomeMenu(Player player) {
    ...
    private void setHome() {
        plotPlayer.getCurrentPlot().setHome(new BlockLoc(
        ...
        player.sendMessage(Component.text(i18n("sethome_successfully")));
    ...
    public void setMenuItems() {
        ...
        if (plotPlayer.getCurrentPlot().getOwner() != player.getUniqueId() && !player.hasPermission("plots.admin.command.sethome")) {
    ...
    private String i18n(String key) {
        String i18n = I18N.getByPlayer(player, "citybuild.pmenu.sethome." + key);
        if (i18n == null) {
            i18n = I18N.getByLang("en_GB", "citybuild.pmenu.sethome." + key);
        }
        if (i18n == null) {
            i18n = "§c§lERROR";
        }
