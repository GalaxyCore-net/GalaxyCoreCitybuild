...
public final class Essential extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        I18N.setDefaultByLang("en_GB", "citybuild.ectoggle", "§cThis enderchest is locked");
        I18N.setDefaultByLang("en_GB", "citybuild.invtoggle", "§cThis inventory is locked");
        I18N.setDefaultByLang("en_GB", "citybuild.enderchest.open", "§cYour enderchest is now open again.");
        I18N.setDefaultByLang("en_GB", "citybuild.enderchest.open", "§cYour enderchest is now closed.");
        I18N.setDefaultByLang("en_GB", "citybuild.inventar.close", "§cYour inventory is now closed.");
        I18N.setDefaultByLang("en_GB", "citybuild.inventar.open", "§cYour inventory is now open.");
        I18N.setDefaultByLang("en_GB", "citybuild.tpoall", "§cYou teleported everyone to you.");
        I18N.setDefaultByLang("en_GB", "citybuild.tp.koordi.self", "§cYou teleported to the coordinates.");
        I18N.setDefaultByLang("en_GB", "citybuild.tp.koordi.other", "§cYou have been teleported to certain coordinates.");
        I18N.setDefaultByLang("en_GB", "citybuild.repair.self", "§cThe item in your hand has been repaired.");
        I18N.setDefaultByLang("en_GB", "citybuild.repair.other", "§cThe item in your hand was repaired by %player%.");
        I18N.setDefaultByLang("en_GB", "citybuild.repair.fail", "§cYou cannot repair this item.");
        I18N.setDefaultByLang("en_GB", "citybuild.repair.other.notify", "§cYou have repaired the item of %player%.");
        I18N.setDefaultByLang("en_GB", "citybuild.ec.usage", "§cBenutze: §e/ec <Player>");
        I18N.setDefaultByLang("en_GB", "citybuild.feed.usage", "§cBenutze: §e/feed <Player>");
        I18N.setDefaultByLang("en_GB", "citybuild.fly.usage", "§cBenutze: §e/fly <Player>");
        I18N.setDefaultByLang("en_GB", "citybuild.god.usage", "§cBenutze: §e/god <Player>");
        I18N.setDefaultByLang("en_GB", "citybuild.heal.usage", "§cBenutze: §e/heal <Player>");
        I18N.setDefaultByLang("en_GB", "citybuild.invsee.usage", "§cBenutze: §e/invsee <Player>");
        I18N.setDefaultByLang("en_GB", "citybuild.skull.usage", "§cBenutze: §e/skull [Player]");
        I18N.setDefaultByLang("en_GB", "citybuild.spawn.usage", "§cBenutze: §e/spawn <Player>");
        I18N.setDefaultByLang("en_GB", "citybuild.speed.usage", "§cBenutze: §e/speed [1-10] <Player>");
        I18N.setDefaultByLang("en_GB", "citybuild.teleport.usage", "§cBenutze: §e/teleport [Player] <Player>");
        I18N.setDefaultByLang("en_GB", "citybuild.tpo.usage", "§cBenutze: §e/tpo [Player] <Player>");
